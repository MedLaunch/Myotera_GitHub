...
void addition_api(const mxArray * const prhs[2], int32_T nlhs, const mxArray
                  *plhs[1])
{
  real_T in1;
  real_T in2;
  ...
  in1 = addition(in1, in2);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(in1);
}

void addition_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  addition_xil_terminate();
  addition_xil_shutdown();
...
/* End of code generation (_coder_addition_api.c) */
