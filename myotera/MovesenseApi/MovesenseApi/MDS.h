...
- (instancetype)init:(NSBundle *)configBundle centralManager:(nullable CBCentralManager *)centralManager deviceUUIDs:(nullable NSArray<NSUUID*> *)deviceUUIDs;
...
typedef NS_ENUM(NSUInteger, MDSLogLevel)
{
    MDSLogLevel_DEBUG,
    MDSLogLevel_INFO,
    MDSLogLevel_ERROR,
